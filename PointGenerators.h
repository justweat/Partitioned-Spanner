...
namespace spanners {
    ...
    public:
        ...
        void generatePointsInsideASquare(const size_t n, const double sizeOfSquare, vector<Point> &P) {
        ...
        void generatePointsOnASquare(const size_t n, const double sizeOfSquare, vector<Point> &P) {
        ...
        void generatePointsOnACircle(const size_t n, const double sizeOfSquare, vector<Point> &P) {
        ...
        void generatePointsOnSpokes(const size_t n, const unsigned numSpokes, vector<Point> &P) {
            //srand(seed());
        ...
        void generatePointsInGalaxy(const size_t n, const unsigned numSpokes, vector<Point> &P) {
        ...
        void generatePointsInsideADisc(const size_t n, const double radiusOfDisk, vector<Point> &P) {
        ...
        void generatePointsInsideASquareNormal(const size_t pointsInACuster,
            ...
            unordered_set<pair<size_t, size_t>, boost::hash<pair<size_t, size_t>>> S;
            ...
            for (size_t c = 0; c < numberOfClusters; c++) {
                ...
                for (size_t i = 0; i < pointsInACuster; i++) {
        ...
        void generateContiguousPointsOnAGrid(const size_t n, vector<Point> &P) {
            points_on_square_grid_2(ceil(std::sqrt(n)), n, std::back_inserter(P), CGAL::Creator_uniform_2<number_t, Point>());
            perturb(P, m_perturbationValue);
        }

        void generateRandomPointsOnAGrid(const size_t n, vector<Point> &P) {
        ...
        void generateRandomInsideAnnulus(const size_t n, const double r2, const double r1, vector<Point> &P) {
            assert(r2 > r1);
            unordered_set<Point> P_unique;
