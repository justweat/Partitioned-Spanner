...
public:
    ...
    spanners::GraphPrinter::OptionsList redEdge {{"color",      "f00202"},
                                                 {"line width", to_string(0.3)}};
    spanners::GraphPrinter::OptionsList bigRed {{"color",      "f00202"},
                                                {"line width", to_string(1.0)}};
    spanners::GraphPrinter::OptionsList vert = {
            {"circle",     ""},
            {"vertex",     (to_string(1))}, // vertex width
